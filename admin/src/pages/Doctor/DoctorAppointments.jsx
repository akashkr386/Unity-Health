    ...
    <div className="w-full max-w-6xl m-5">
      ...
      <div className="bg-white border border-zinc-300 rounded text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll">
        ...
        {appointments.reverse().map((item, index) => (
          <div
            key={index}
            className="flex flex-wrap justify-between max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items-center text-gray-500 py-3 px-6 border-b border-zinc-300 hover:bg-gray-50 cursor-pointer"
          >
